...
VALUES ('John', 'Roman', 18, 'Red'),
       ('Bill ', 'Jones', 32, 'Dog'),
       ('Roosevelt ', 'Garold ', 32, 'Big Cat'),
       ('Unknown', 'Unknown', 55, 'Big Jo'),
       ('Artist5', 'Artist5', 44, 'White Cat'),
       ('Artist6', 'Artist6', 21, 'Big Susan'),
       ('Artist7', 'Artist7', 45, 'Unknown'),
       ('Artist8', 'Artist8', 12, 'Nameless'),
       ('Artist9', 'Artist9', 33, 'Good Name'),
       ('Artist10', 'Artist10', 24, 'Bad Bob');
